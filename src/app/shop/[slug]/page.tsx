          ...
          <div className="w-full lg:w-[45%] lg:pt-8">
            ...
            >
              ...
              <div className="flex items-center space-x-4 mb-6">
                <span className="text-xl text-brand-charcoal/60 line-through">Rs. {formatPrice(product.originalPrice || 0)}</span>
                <span className="text-xl font-semibold text-red-600">Rs. {formatPrice(product.price)}</span>
              </div>
